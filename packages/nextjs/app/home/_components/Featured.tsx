...
const Featured = ({ songMetadata }: FeaturedProps) => {
	...
	const coverUrl = getFileUrl(songMetadata.album.imageCID);

	return (
		<div className="relative w-full rounded-xl overflow-hidden my-3" style={{ aspectRatio: "21/6", minHeight: "8rem" }}>
			{/* fondo borroso */}
			<Image src={coverUrl} alt="" fill className="object-cover scale-110 blur-sm opacity-40" sizes="100vw" priority />
			{/* overlay oscuro */}
