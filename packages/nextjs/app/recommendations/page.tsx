	...
	return (
		<div className="py-8 px-4">
			<div className="max-w-2xl mx-auto">
				<h1 className="text-3xl font-bold mb-8 text-base-content">Recommendations</h1>

				{/* Train Button */}
				<div className="mb-8">
					<button onClick={handleTrainModel} disabled={trainingLoading} className="btn btn-primary">
						{trainingLoading ? <span className="loading loading-spinner loading-sm"></span> : "Train Model"}
					</button>
				</div>

				{/* User Recommendations */}
				<div className="mb-12 border border-base-300 p-6 rounded-lg bg-base-200">
					<h2 className="text-xl font-bold mb-4 text-base-content">Your Recommendations</h2>
					{address ? (
						<>
							...
							<button onClick={handleRecommendByUser} disabled={loadingUser} className="btn btn-primary btn-sm mb-4">
								{loadingUser ? <span className="loading loading-spinner loading-sm"></span> : "Refresh"}
							</button>
						...
						<p className="text-base-content/60">Connect your wallet to see recommendations</p>
					)}
				</div>

				{/* Song Recommendations */}
				<div className="border border-base-300 p-6 rounded-lg bg-base-200">
					<h2 className="text-xl font-bold mb-4 text-base-content">Find Similar Songs</h2>
					<div className="mb-4">
					...
					>
						{loadingSong ? <span className="loading loading-spinner loading-sm"></span> : "Search"}
					</button>
					{recommendationsSong.length > 0 ? (
						...
						<p className="text-base-content/60">No recommendations found</p>
					) : null}
				</div>
			</div>
		</div>
