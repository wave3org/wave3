...
type WriteWavecoinFn = (params: { functionName: "approve"; args: [Address, bigint] }) => Promise<Hash | undefined>;

type WriteRoyaltiesFn = (params: { functionName: "playSong"; args: [bigint] }) => Promise<Hash | undefined>;
